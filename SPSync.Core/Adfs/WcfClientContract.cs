...
namespace SPSync.Core.Adfs
{
    ...
    public partial class WSTrustFeb2005ContractClient : ClientBase<IWSTrustFeb2005Contract>, IWSTrustFeb2005Contract
    {
        ...
        public IAsyncResult BeginIssue(Message request, AsyncCallback callback, object state) => base.Channel.BeginIssue(request, callback, state);

        public Message EndIssue(IAsyncResult asyncResult) => base.Channel.EndIssue(asyncResult);
    }
